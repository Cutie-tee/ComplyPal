...
Generate a structured compliance report."""
                ...
                st.write(response)
                 ...
                 # Add guidance message for chat assistant
                st.markdown("""
                    ---
                    ### 💬 Need More Guidance?
                    
                    Click on the "Chat Assistant" tab above to interact with ComplyPal directly. Our AI assistant can:
                    - Answer specific questions about your compliance requirements
                    - Provide detailed implementation guidance
                    - Help you understand regulatory obligations
                    - Offer practical compliance solutions
                    
                    Simply switch to the Chat Assistant tab to start a conversation and get personalised support.
                    ---
                """)
            ...
            with st.expander("💡 Suggested Questions", expanded=False):
                if st.button("Get Suggestions", use_container_width=True):
                    with st.spinner("Generating suggestions..."):
                        ...
                        suggestion_prompt =  f"""Based on the compliance assessment and our conversation history, please generate three focused follow-up questions to help deepen the discussion of key compliance requirements and implementation strategies.

Please consider:
- Critical compliance requirements identified in the assessment that warrant further exploration
- Potential compliance gaps or risk areas that need additional clarification
- Practical implementation steps and documentation requirements
- Specific regulatory obligations relevant to the user's context
- Areas where more detailed guidance would be valuable
...
Please provide three carefully crafted questions that will elicit detailed, actionable responses about compliance implementation, regulatory requirements, and risk management strategies. Each question should build naturally on the previous discussion while exploring new aspects of compliance that would benefit from further examination."""
